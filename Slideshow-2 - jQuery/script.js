...
-The only code for the Interval, is the myInterval variable,
the imageLoop function, and the imageDelay variable
*/
...
$(document).ready(function() {
	...
	//INTERVAL FOR IMAGE LOOP
	let myInterval = setInterval(imageLoop, imageDelay);
	
	function imageLoop() {
		let prev = imageNum;
		if (imageNum !== images.length-1) { //if not at the end
			imageNum++;
