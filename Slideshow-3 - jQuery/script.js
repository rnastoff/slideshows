...
let images = [
	...
	let imageNum = 0; //index of currently viewed image (changes)
...
$(document).ready(function() {
	...
	//ARROWS EVENT LISTENER - THESE TWO FUNCTIONS CAN BE REFACTORED INTO 1 (TERNARY)	
	...
	//ARRANGE OBJECT FOR INFINITE LOOP
	function arrange() {
		if (imageNum == 0) {
			let temp = images.pop();
			images.unshift(temp);			
